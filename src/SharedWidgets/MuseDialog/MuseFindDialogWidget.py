...
class MuseFindDialog(MuseDialog, MuseFindDialogView):
    ...
    def __init__(self, size: QSize, attributes: dict[str, MuseTableWidget.ItemType], parent_signal: TupleEmitter):
        ...
        self._scroll_area_layouts = []
        self._attribute_types: dict[str, MuseTableWidget.ItemType] = {}

        self.filterComboBox.addItems(list(attributes.keys()))
        self._attribute_types = attributes
    ...
    def add_filter(self):
        ...
        self._scroll_area_layouts[-1].append(data_source)
    ...
    def remove_filter(self):
        self._scroll_area_layouts[-1][0].removeWidget(self._scroll_area_layouts[-1][1])
        self._scroll_area_layouts[-1][0].removeWidget(self._scroll_area_layouts[-1][2])
        self._scroll_area_layouts.pop(-1)

        self.filterComboBox.addItem(self._active_filters.pop(-1))
