...
from PyQt5.QtWidgets import QVBoxLayout, QScrollArea, QWidget, QSizePolicy
...
class CuratorRequestsDialog(MuseDialog):
    ...
    def __init__(self, parent_signal: TupleEmitter = TupleEmitter(None)):
        ...
        self.requests.setSizePolicy(QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding))
