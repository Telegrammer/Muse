...
class AdministratorMainWindowView(object):
    ...
    def retranslateUi(self, AdministratorMainWindow):
        ...
        self.checkBoxName.setText(_translate("AdministratorMainWindow", "Фамилия"))
        ...
        self.checkBoxExhibitName.setText(_translate("AdministratorMainWindow", "Название"))
        self.checkBoxExhibitType.setText(_translate("AdministratorMainWindow", "Вид"))
        self.checkBoxArea.setText(_translate("AdministratorMainWindow", "Зал"))
